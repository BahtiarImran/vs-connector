...
enum AD7_HRESULT
{
    ...
    // Other programs cannot be debugged while debugging a dump file.
    ...
    // Windows 8 build# 8017 or higher is required to debug Windows Metro style applications.
    ...
    // A Microsoft Window component is not correctly registered. Please ensure that the Desktop Experience is enabled in Server Manager -> Manage -> Add Server Roles and Features.
